...
class TiposVariosController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('TipoTercero/index', compact('datos'));
    }
    ...
    public function create()
    {
        ...
        return view('TipoTercero/agregar', compact('tiposvarios'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('TipoTercero/eliminar', compact('tiposvarios'));
    }
    ...
    {
        $tiposvarios = TiposVarios::find($id);
        return view('TipoTercero/actualizar', compact('tiposvarios'));
    }
