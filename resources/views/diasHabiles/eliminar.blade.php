    ...
    <div class="card-body">
      ...
      <p class="card-text">
        ...
        <table class="table table-sm table-hover">
            ...
            <tbody>  
                <tr>
                    <td>{{ $diasHabiles->dias_fecha}}</td>                                
                </tr>
            </tbody>
        </table>
        <hr>

        <form action="{{ route('diasHabiles/diasHabiles.destroy', $diasHabiles->id) }}" method="POST">
            @csrf
            @method('DELETE')
              <a href="{{route('diasHabiles')}} " class="btn btn-sm btn-info"> 
